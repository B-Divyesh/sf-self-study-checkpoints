...
The demo starts with Maya Chen’s eight-week finite-groups checkpoint. It includes two linked problems, a four-part rubric, a named peer reviewer, and one draft evidence link. The yellow banner remains visible while the sample is active.
